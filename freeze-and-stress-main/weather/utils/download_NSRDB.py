...
class NSRDBDownloader:
    ...
    def __init__(self, api_key: str, email: str):
        ...
        self.cities = {
            "Los_Angeles": [-118.4085, 33.9425, 'goes_aggregated', (1998, 2024)],
            "Miami":       [-80.2870,  25.7959, 'goes_aggregated', (1998, 2024)],
            "Montreal":    [-73.7408,  45.4706, 'goes_aggregated', (1998, 2024)],
            "Toronto":     [-79.6306,  43.6772, 'goes_aggregated', (1998, 2024)],
            "Phoenix":     [-112.0740, 33.4484, 'goes_aggregated', (1998, 2024)],
            "Vancouver":   [-123.1207, 49.2827, 'goes_aggregated', (1998, 2024)],
        }
    ...
    def save_data(self, df: pd.DataFrame, filename: str = None, output_dir: str = None):
        """
        ...
        if output_dir is None:
            output_dir = str(Path(__file__).parent.parent / "data" / "NSRDB")
